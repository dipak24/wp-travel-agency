...
$section_id = 'contact-form-' . $block['id'];

//Check for section padding
$section_padding = rha_get_block_style();

//Check if section is enable or disable
$section_enable = get_field('contact_form_enable_section');
if ($section_enable) {
    $rha_four_form = get_field('contact_form_shortcode');
    $section_title = get_field('contact_form_title');
    $contactInfo = get_field('blocak_contact_information');
    ?>

    <section id="<?php echo esc_attr($section_id); ?>"
        class="section section-contact-form <?php echo $section_padding; ?>">
        <div class="container">
            <div class="row justify-content-between ">
                <div class="col-md-7 col-lg-6 form-wrap">
                    ...
                    <?php if (!empty($rha_four_form)) {
                        $shortcode = '[gravityform id="' . $rha_four_form['id'] . '" title="false" description="false" ajax="true"]'; ?>
                ...
                <div class="col-md-5">
                    <div class="contact-information">
                        <div class="single-contact">
                            ...
                            <div class="content">
                                <h6><a href="tel:+9779860110433">+977 9860110433</a></h6>
                                <h6><a href="tel:+9779860472458">+977 9860472458</a></h6>
                            </div>
                        </div>

                        <div class="single-contact">
                            <div class="title"><h6>Email</h6></div>
                            <div class="icon">
