				...
				<div class="col-12">
					...
					<div class="single-content">
						<div class="blog-page-heading">
							...
							<?php } else { ?>
                    			<img src="<?php echo esc_url(RHA_THEME_IMAGES_DIR.'blog-image.png'); ?>" alt="blog-image" alt="blog-image" width="855" height="440" />
							<?php } ?>
									...
									<ul>
										<li>
											<a href="javascript:void(0)" class="share-link">
												<img src="<?php echo esc_url(RHA_THEME_IMAGES_DIR.'/social-icons/icon-link-share.svg'); ?>" alt="Link" width="20" height="20">
											</a>
										</li>
										<li>
											<a class="resp-sharing-button__link" href="<?php echo esc_url('https://www.linkedin.com/shareArticle?mini=true&amp;url='.$social_link); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Share on LinkedIn">
												<div class="resp-sharing-button resp-sharing-button--linkedin resp-sharing-button--large">
													<div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
														<img src="<?php echo esc_url(RHA_THEME_IMAGES_DIR.'/social-icons/icon-instagram-share.svg'); ?>" alt="Linkedin Icon" width="20" height="20">
													</div>
												</div>
											</a>
										</li>
										<li>
											<a class="resp-sharing-button__link" href="<?php echo esc_url('https://facebook.com/sharer/sharer.php?u='.$social_link); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Share on Facebook">
												<div class="resp-sharing-button resp-sharing-button--facebook resp-sharing-button--large">
													<div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
														<img src="<?php echo esc_url(RHA_THEME_IMAGES_DIR.'/social-icons/icon-facebook-share.svg'); ?>" alt="Facebook" width="20" height="20">
													</div>
												</div>
											</a>
										</li>
										<li>
											<a class="resp-sharing-button__link" href="<?php echo esc_url('https://twitter.com/intent/tweet/?url='.$social_link); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Share on Twitter">
												<div class="resp-sharing-button resp-sharing-button--twitter resp-sharing-button--large">
													<div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
														<img src="<?php echo esc_url(RHA_THEME_IMAGES_DIR.'/social-icons/icon-twitter-share.svg'); ?>" alt="Twitter Icon" width="20" height="20">
													</div>
												</div>
											</a>
										</li>
									...
									<div class="col-12 col-lg-8 col-xl-9 col-content">
										<div class="content-wrap">
											...
											<div class="author-box">
												<div class="img-wrap">
													<?php if($user_pic && isset($user_pic['url'])) { ?>
														<img src="<?php echo esc_url($user_pic['url']); ?>" alt="<?php echo $user_pic['alt'] ? esc_attr($user_pic['alt']) : esc_attr($user_pic['title']); ?>" />
													<?php } else { ?>
												...
												<div class="text-wrap">
													<div class="user-info">
														<strong class="author-name"><?php echo $full_name; ?></strong>
														<?php $user_designation = get_field('user_designation', 'user_'.$author_id);
														if($user_designation) { ?>
															<span class="designation"><?php echo esc_html($user_designation); ?></span>
														<?php 
														} ?>
													</div>
													<?php
													$author_desc = get_field('user_description', 'user_'.$author_id);
													if($author_desc != '') { ?>
														<p><?php echo wp_kses_post($author_desc); ?></p>
													<?php 
													}
													$author_id = get_the_author_meta( 'ID' ); ?>
													<a href="<?php echo esc_url( get_author_posts_url( $author_id  ) ); ?>" class="link-arrow"><?php esc_html_e('Read more Articles by this Author', 'Royal_Holidays_Adventures'); ?></a>
												</div>
											</div>
										</div>
									</div>
				...
				<div class="blog-post related-blog">
					<div class="blog-post-wrap">
						<div class="blog-post-wrap-title d-flex justify-content-between align-items-center">
							<h2><?php esc_html_e('See more articles like this', 'Royal_Holidays_Adventures'); ?></h2>
							<?php if ($arr) { ?>
						...
						<div class="row">
							<?php while($my_query->have_posts()) {
								...
								echo '<div class="col-md-4">';
									get_template_part( 'template-parts/grid-layout/blog', 'grid' );
								echo '</div>';
							} wp_reset_postdata(); ?>
						</div>
					</div>
